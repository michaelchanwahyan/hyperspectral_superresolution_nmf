    ...
    if( ~exist(trialFolderName,'dir') ) ; mkdir( trialFolderName ) ; end ;
        ...
        if( ~exist( 'finish.txt' , 'file' ) )
            if( ~exist( 'someOneIsHere.txt' , 'file' ) )
                ...
                % DRFUMI Var < 5e-3 %
                % ================= %
                fprintf( 'HIS by DRFUMI Var < 5e-3\n' ) ;
                ...
                if( ~exist( logFileName , 'file' ) )
                    ...
                    DRFUMI_opt.maxIteraNum  = 1e4        ; DRFUMI_opt.convthresh   = 5e-3        ;
                ...
                % =============================== %
                % CNMF subprob It 100 convth 5e-3 %
                % =============================== %
                fprintf( 'HIS by CNMF subprobIt 100 convth 5e-3\n' ) ;
                ...
                if( ~exist( logFileName , 'file' ) )
                    ...
                    CNMF_opt.maxIteraNum  = 1e4    ; CNMF_opt.convThresh   = 5e-3   ;
                ...
                if( ~exist( logFileName , 'file' ) )
                    ...
                    MF_opt.maxIteraNum = 1e4     ; MF_opt.convthresh     = 5e-3       ;
                    MF_opt.AStep       = 1       ;
                    MF_opt.SStep       = 1       ;
