...
cd SNR_40dB
    cd trial0001
        ...
        load( 'LOG_MFbA_HYBRID_S_FWrandi10_A_FISTArandi10_subprobIt_randi10.mat' , 'returnInfo_MF'   ) ; obj = returnInfo_MF.obj_it   ; obj_MFbA_HYBRID_S_FWr10_A_FISTAr10_subprobIt_r10 = obj(obj>0) ;
        fid = figure ;
        ...
        k = k + 1 ; handle{k} = plot( 10*log10( obj_MFbA_HYBRID_S_FWr10_A_FISTAr10_subprobIt_r10 ) , [colorArr{k},lnstyArr{k}] , 'LineWidth' , lineWidthVal ) ; yticks([0,10,20,30,40]) ; yticklabels({'10^0','10^1','10^2','10^3','10^4'}) ;
        ...
        k = k + 1 ; handle{k} = plot( 10*log10( obj_MFbA_HYBRID_S_FWr10_A_FISTAr10_subprobIt_r10 ) , [colorArr{k},lnstyArr{k}] , 'LineWidth' , lineWidthVal ) ; xlim([0,itlim_small]) ; ylim([5,objlim_small]) ; yticks([0,10,20,30,40]) ; yticklabels({'10^0','10^1','10^2','10^3','10^4'}) ;
        grid on ;
    cd ..
cd ..
