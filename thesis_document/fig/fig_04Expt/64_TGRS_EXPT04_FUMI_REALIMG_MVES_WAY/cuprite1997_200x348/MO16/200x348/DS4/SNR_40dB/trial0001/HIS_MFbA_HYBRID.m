...
if( strcmp( AStep , 'randi' ) ) ; A_HYBRID_RANDI_STEP = true  ; A_HYBRID_RANDI_BASE = MFbA_opt.A_HYBRID_RANDI_BASE ; end ;
if( strcmp( SStep , 'randi' ) ) ; S_HYBRID_RANDI_STEP = true  ; S_HYBRID_RANDI_BASE = MFbA_opt.S_HYBRID_RANDI_BASE ; end ;
